...
parser.add_argument('--n_iter', type=int, default=3, help='number of GNN/GNN_R iterations/layers (default: 1)')
...
# Data settings
parser.add_argument('--data', type=str, default='animal_world__K6_N25_D8_A100_M20_cr0.00.pickle', help='dataset filename')
...
parser.add_argument('--subtype', type=int, default=2, help='question subtypes we want to test')
